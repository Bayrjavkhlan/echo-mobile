...
CREATE TABLE `__new_reviews` (
	...
	`created_at` text DEFAULT '2025-05-06T07:11:06.907Z',
...
ALTER TABLE `flashcard_labels` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `flashcards` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `groups` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `labels` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `settings` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `user` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `flashcard_review` ADD `is_active` integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE `wrong_answers` ADD `is_active` integer DEFAULT 0;