...
CREATE TABLE `__new_reviews` (
	...
	`created_at` text DEFAULT '2025-05-20T18:22:34.456Z',
...
ALTER TABLE `wrong_answers` DROP COLUMN `correct_text`;--> statement-breakpoint
ALTER TABLE `wrong_answers` DROP COLUMN `user_id`;--> statement-breakpoint
ALTER TABLE `wrong_answers` DROP COLUMN `server_id`;--> statement-breakpoint
ALTER TABLE `wrong_answers` DROP COLUMN `created_at`;--> statement-breakpoint
ALTER TABLE `wrong_answers` DROP COLUMN `updated_at`;--> statement-breakpoint
ALTER TABLE `wrong_answers` DROP COLUMN `updated_by`;